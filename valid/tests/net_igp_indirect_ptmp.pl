...
return ["net igp indirect (ptmp)",
	"cbgp_valid_net_igp_indirect_ptmp"];
...
sub cbgp_valid_net_igp_indirect_ptmp($) {
  ...
  $cbgp->send_cmd("net add subnet 192.168.2.0/24 transit");
  ...
  $cbgp->send_cmd("net add link 1.0.0.1 192.168.2.1/24");
  $cbgp->send_cmd("net add link 1.0.0.4 192.168.2.2/24");
  ...
  $cbgp->send_cmd("net link 1.0.0.1 192.168.2.1 igp-weight 10000");
  $cbgp->send_cmd("net link 1.0.0.4 192.168.2.2 igp-weight 10000");
